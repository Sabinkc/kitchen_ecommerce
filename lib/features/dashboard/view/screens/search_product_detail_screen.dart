...
class SearchDetailScreen extends ConsumerStatefulWidget {
  final int prodIndex;
  const SearchDetailScreen({super.key, required this.prodIndex});

  @override
  ConsumerState<SearchDetailScreen> createState() =>
      _ProductDetailScreenState();
}

class _ProductDetailScreenState extends ConsumerState<SearchDetailScreen> {
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      if (searchRef.searchProd[widget.prodIndex].isOffer ==
                          true)
                        Positioned(
                          top: 10,
                          right: 0,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              searchRef.searchProd[widget.prodIndex].category,
                              style: const TextStyle(
                                color: Colors.grey,
                                fontWeight: FontWeight.bold,
                              ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  searchRef.searchProd[widget.prodIndex].rating,
                                  style: const TextStyle(
                                    color: Colors.grey,
                                    fontWeight: FontWeight.bold,
                                  ),
                        ...
                        Text(
                          searchRef.searchProd[widget.prodIndex].productDetails,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              // "Specifications",
                                              "${searchRef.searchProd[widget.prodIndex].dynamicData.keys.elementAt(index)}",
                                              style: const TextStyle(
                                                fontSize: 16,
                                              ),
                                            ),
            ...
            Flexible(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ),
                  searchRef.searchProd[widget.prodIndex].isOffer == true
                      ? Row(
                          children: [
                            Text(
                              "Rs.",
                            ...
                            Text(
                              searchRef.searchProd[widget.prodIndex].price,
                              style: TextStyle(
                ...
                onPressed: () {
                  cartRefR.addToCart(
                    CartItemModel(
                      ...
                      prodName:
                          searchRefR.searchProd[widget.prodIndex].prodName,
                      // img: botmProdRefR.botmProducts[widget.prodIndex].img,
                      img: detRef.prodImages[0],
                      category:
                          searchRefR.searchProd[widget.prodIndex].category,
                      price: searchRefR.searchProd[widget.prodIndex].price,
                      quantity: 1,
                      isOffer: searchRefR.searchProd[widget.prodIndex].isOffer,
                      discountPercent: searchRefR
                          .searchProd[widget.prodIndex]
                          .discountPercent,
                      priceAfterDis:
                          searchRefR.searchProd[widget.prodIndex].priceAfterDis,
                      isSelected: true,
